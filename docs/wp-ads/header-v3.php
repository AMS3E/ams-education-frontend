...
src="https://www.facebook.com/tr?id=694960145106572&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
...
/* Damrei - Underlay */
gammatag.defineZone({code:"gax-inpage-async-1729764934",size:[640,1386],params:{siteId:"1721642224",zoneId:"1729764934",zoneType:"Inpage"}});
...
/* Damrei - MR1*/
gammatag.defineZone({code:"gax-inpage-async-1729764905",size:[300,250],params:{siteId:"1721642224",zoneId:"1729764905",zoneType:"Inpage"}});

/* Damrei - Underlay - 2 */
gammatag.defineZone({code:"gax-inpage-async-1731396715",size:[640,1386],params:{siteId:"1721642224",zoneId:"1731396715",zoneType:"Inpage"}});

/* Damrei - Footer*/
gammatag.defineZone({code:"gax-inpage-async-1729766383",size:[720,250],params:{siteId:"1721642224",zoneId:"1729766383",zoneType:"Inpage"}});
/* Damrei - MR1 Desktop */
...
<script>
    ...
    function loadGammaTagForScreenSize() {
        ...
        if (screenWidth > 500) {
            gammatag.cmd.push(function() {
                gammatag.defineZone({code:"gax-inpage-async-1725879986",size:[728,90],params:{siteId:"1725879762",zoneId:"1725879986",zoneType:"Inpage"}});
                gammatag.sendRequest();
            });
        }
    }
